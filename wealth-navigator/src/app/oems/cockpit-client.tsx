          ...
          <div className="min-w-0 space-y-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground max-w-2xl leading-relaxed">
                Centralized execution &amp; portfolio oversight across active model baskets, certified
                factsheets, and JSE market liquidity.
              </p>
            </div>
          </div>
        ...
        <div className="relative mt-2 flex flex-wrap items-center gap-x-5 gap-y-1 border-t border-foreground/[0.06] pt-2 text-[11px]">
          ...
          <div className="glass-inset p-3.5 flex flex-col justify-between space-y-2">
            <div className="flex items-center justify-between">
              ...
              <span className="font-mono text-[10px] text-muted-foreground uppercase">Constituents</span>
            </div>
            <div>
              ...
              <p className="text-[11px] text-muted-foreground truncate">
                {universeSize > 0
                  ? `${universeSize} JSE & Global Assets Tracked`
                  : "Active Multi-Asset Weights"}
              </p>
            </div>
          </div>
          ...
          <div className="glass-inset p-3.5 flex flex-col justify-between space-y-2">
            <div className="flex items-center justify-between">
              ...
              <span className="font-mono text-[10px] text-muted-foreground uppercase">Governance</span>
            </div>
            <div>
              <p className="text-lg font-bold font-mono tracking-tight text-foreground">
